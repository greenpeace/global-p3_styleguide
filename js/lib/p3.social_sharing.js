    ...
    var _p3 = $.p3 || {},
            defaults = {
                ...
                networks: {
                    ...
                    twitter: {
                        enabled: true,
                        url: 'https://platform.twitter.com/widgets/tweet_button.html?original_referer=__REFERRER__&source=tweetbutton&text=__TITLE__&url=__REFERRER__&via=__ACCOUNT__',
                        count: 0,
                        title: false,
                        account: 'greenpeace'
                    },
...
//                                throw new Error('Twitter sharing requires a title');
                    ...
                    $a.attr({
                        ...
                        if (support && (network === 'facebook' || network === 'twitter') ) {
                            ...
                            // sigh
                            w.open(url, 'Share this page', 'left=200,top=100,width=550,height=350,toolbar=1,resizable=1');
                        }
                    });
